...
function formView(_dispatch, _model) {
  var description = _model.description,
      calories = _model.calories; // return button(
  ...
  return form({
    className: "w-100 mv2"
  }, [fieldSet("DESCRIPTION", description) // if calories is 0, then display empty cell
